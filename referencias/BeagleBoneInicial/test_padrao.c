...
void signalhandler(int signo)
{
    ...
    cycle(ele_inicial, (ele_inicial + padrao) % 32);
...
int main(int argc, char *argv[])
{
    ...
    if ((argc > 1) && (strcmp(argv[1], "man") == 0))
    {
        ...
        if (argc == 4) {
            ...
            printf("Quantidade de Parâmetros Incorreta\nUsage:\n");
            printf("%t%s man <ele_entrada> <ele_saida>\n", argv[0]);
        }
    }
    else
    {
...
/*
 ...
 A implementacao usa GPIO1.28-31 como CODE1, GPIO2.22-25 como CODE2, GPIO3.14-17 como S00-034
                                                                     Pg9.31-28
