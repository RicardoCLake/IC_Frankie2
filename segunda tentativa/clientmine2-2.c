//Shows pings with a histogram and ping with a delay
...
#define IPS "169.254.101.43"
#define TIMES 2000
#define LENGTH 500       //of the graphic
#define INTERVAL 3    //of each collum of the graphic 
...
{ 
    ...
    //printing results
    int ratio = (TIMES*INTERVAL)/(20000);
    //(TIMES*INTERVAL)/(1350)
